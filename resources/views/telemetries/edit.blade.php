        ...
        <form role="form" method="POST" class="p-4" action="{{ route('telemetries.update', encrypt($telemetry->id)) }}">
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <div class="inline-flex items-center relative">
                        ...
                        <input type="text"
                            value="{{ old('created_at', request('created_at', $telemetry->created_at)) }}"
                            name="created_at"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('debit', request('debit', $telemetry->debit)) }}"
                        name="debit"
                        placeholder="Debit"
                        class="input input-bordered input-primary w-full"
                    >
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('temperature', request('temperature', $telemetry->temperature)) }}"
                        name="temperature"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('humidity', request('humidity', $telemetry->humidity)) }}"
                        name="humidity"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('wind_direction', request('wind_direction', $telemetry->wind_direction)) }}"
                        name="wind_direction"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('solar_radiation', request('solar_radiation', $telemetry->solar_radiation)) }}"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('evaporation', request('evaporation', $telemetry->evaporation)) }}"
                        name="evaporation"
            ...
            <div class="mb-4 px-3">
                <label class="form-control w-full">
                    ...
                    <input type="text"
                        value="{{ old('dissolve_oxygen', request('dissolve_oxygen', $telemetry->dissolve_oxygen)) }}"
